...
```
Use the /release skill to release v0.3.2
```
...
```
Use the /release skill to tag v0.3.2
```
...
This triggers the Docker workflow which publishes `ghcr.io/dannys-janssen/dbv:v0.3.2`, `:0.3.2`, `:0.3`, `:0`, and `:latest`.
