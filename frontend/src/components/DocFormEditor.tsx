...
const typeTagStyle = (type: string): React.CSSProperties => {
  const colors: Record<string, string> = {
    date: "var(--dbv-form-type-date)",
    objectId: "var(--dbv-form-type-object-id)",
    bool: "var(--dbv-form-type-bool)",
    int: "var(--dbv-form-type-number)",
    long: "var(--dbv-form-type-number)",
    double: "var(--dbv-form-type-number)",
    decimal: "var(--dbv-form-type-number)",
    string: "var(--dbv-form-type-string)",
    object: "var(--dbv-form-type-structure)",
    array: "var(--dbv-form-type-structure)",
    uuid: "var(--dbv-form-type-uuid)",
  };
  return {
    fontSize: 10,
    fontWeight: 700,
    color: colors[type] ?? "var(--dbv-form-muted)",
      ...
      <div style={{ display: "flex", alignItems: "center", marginBottom: 10, gap: 8 }}>
        ...
        {!isId && (
          <button
            ...
            style={{
              marginLeft: 8,
              background: "var(--dbv-form-remove-bg)",
              border: "1px solid var(--dbv-form-remove-border)",
              borderRadius: 999,
              color: "var(--dbv-form-remove-text)",
              cursor: "pointer",
              fontSize: 12,
              padding: "3px 8px",
              lineHeight: 1,
...
const DocFormEditor: React.FC<DocFormEditorProps> = ({ schema, value, onChange, isEditing }) => {
  ...
  const formThemeVars = {
    ...
    "--dbv-form-remove-bg": alpha(theme.palette.error.main, theme.palette.mode === "dark" ? 0.2 : 0.08),
    "--dbv-form-remove-border": alpha(theme.palette.error.main, theme.palette.mode === "dark" ? 0.5 : 0.35),
    "--dbv-form-remove-text": theme.palette.error.main,
    "--dbv-form-type-date": theme.palette.info.main,
    "--dbv-form-type-object-id": theme.palette.secondary.main,
    "--dbv-form-type-bool": theme.palette.warning.main,
    "--dbv-form-type-number": theme.palette.success.main,
    "--dbv-form-type-string": theme.palette.text.primary,
    "--dbv-form-type-structure": theme.palette.text.secondary,
    "--dbv-form-type-uuid": theme.palette.warning.light,
